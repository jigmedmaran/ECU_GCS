...
// Type: ECU_GCS.C1_Request_Common
...
namespace ECU_GCS
{
  public static class C1_Request_Common
  {
    public static T1_Request_Common Data;
    public static byte Type = 1;
    public static int Length = Marshal.SizeOf<T1_Request_Common>(C1_Request_Common.Data);
